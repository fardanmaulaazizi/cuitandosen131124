            ...
            <div class="card-body">
                <form action="{{url('admin-tryout/update-soal-sesi/'.$soal->id)}}" method="post" >
                    ...
                    <div class="mb-3">
                        ...
                        <div  id="list-pilgan">
                            @foreach ($soal->pilgan_sesis as $key => $pg)
                            <div class="row d-flex justify-content-start mb-3 curr-field">
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <input type="hidden" name="id_curr[]" value="{{$pg->id}}">
                                </div>
                                <div class="col-md-2 ">
