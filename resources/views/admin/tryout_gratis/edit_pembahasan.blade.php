...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <h5><a class="text-dark me-2" href="{{url('admin')}}"><i class="fa fa-home"></i></a> > <a href="{{url('admin-free-tryout')}}" class="text-dark ms-2 me-2">Tryout Gratis</a> > <a href={{route('admin-free-tryout.edit', $soal->tryout->id)}} class="text-dark me-2 ms-2">Edit {{$soal->tryout->nama}}</a> > <span class="ms-2">Edit Pembahasan</span></h5>
        </div>
        <div class="card">
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{url('free-edit-pembahasan/'.$soal->id)}}" method="post" >
                    @csrf
