...
<div class="container-fluid" >
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <h5><a class="text-dark me-2" href="{{url('admin')}}"><i class="fa fa-home"></i></a> > <a href="{{url('admin-free-tryout')}}" class="text-dark ms-2 me-2">Tryout Gratis</a> > <a href="{{url('admin-free-tryout/list-hasil/'.$ts->tryout->id)}}" class="text-dark me-2 ms-2">{{$ts->tryout->nama}}</a> > <sapan class="ms-2">Pembahasan</sapan></h5>
        </div>
        <div class="row">
            <div class="col-md-9">
                <div class="card">
            ...
            <div class="col-md-3">
                <div class="card " style="position: sticky; top:80px">
                    <div class="card-body">
                        ...
                        <button class="btn {{buttonClass($so2->pembahasan, myNilai($ts->id, $so2->id))}} {{$key2 == 0 ? 'btn-active' : ''}} ms-1 button-soal " data-key="{{$key2}}" id="button-{{$key2}}">
                            {{$loop->iteration}}
                        </button>
                        @endforeach
                    </div>
